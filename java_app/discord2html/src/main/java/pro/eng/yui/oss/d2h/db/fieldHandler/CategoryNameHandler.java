...
@MappedTypes(CategoryName.class)
public class CategoryNameHandler extends BaseTypeHandler<CategoryName> {
    @Override
    ...
    public CategoryName getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return rs.wasNull() ? null : new CategoryName(val);
    }
    ...
    public CategoryName getNullableResult(CallableStatement cs, int columnIndex) throws SQLException {
        ...
        return cs.wasNull() ? null : new CategoryName(val);
    }
}
